...
export function Footer() {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    if (!EMAIL_REGEX.test(trimmedEmail)) {
      setNewsletterError('Please enter a valid email address (e.g. name@example.com).')
      return
    }
        ...
        <div className="footer-bottom-bar">
          ...
          <div className="footer-bottom-right-wrap">
            <div className="footer-social-list bottom-socials">
              ...
              <a href="https://www.youtube.com/@TheAPLT20" target="_blank" rel="noopener noreferrer" className="social-circle youtube" aria-label="YouTube">
                <svg viewBox="0 0 24 24" width="22" height="22" fill="#ffffff">
              ...
              <a href="https://www.tiktok.com/@afghanistan.premie?_r=1&_t=ZS-99BJ9dyrRqB" target="_blank" rel="noopener noreferrer" className="social-circle tiktok" aria-label="TikTok">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="#ffffff">
