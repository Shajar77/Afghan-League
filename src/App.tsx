  ...
  return (
    <div className="app-container">
      ...
      <main className="app-main">
              ...
              <div className="teams-video-container">
                <div className="teams-video-wrapper">
                  ...
                  <div className="teams-video-logo-wrapper">
                    <img src={aplLogo} alt="APL Logo" className="teams-video-logo" loading="lazy" />
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Cricket Ball Stitched Seam Separator Section */}
        <div className="cricket-seam-separator">
          ...
          {/* Bouncing & Rolling Cricket Ball Overlay */}
            ...
            <table className="points-table">
              <thead>
                <tr>
                  ...
                  <th title="Won">W</th>
                  <th title="Lost">L</th>
                  <th className="pt-col-nr" title="No Result">NR</th>
              ...
              <tbody>
                {[
                  { rank: 1, name: 'Kabul Knights',       m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: true },
                  { rank: 2, name: 'Kandahar Kings',      m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: true },
                  { rank: 3, name: 'Balkh Legends',       m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: true },
                  { rank: 4, name: 'Paktia Panthers',     m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: true },
                  { rank: 5, name: 'Amo Sharks',          m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: false },
                  { rank: 6, name: 'Band-e-Amir Dragons', m: 0, w: 0, l: 0, nr: 0, nrr: '+0.000', pts: 0, top: false },
                ].map((team) => (
                  <tr key={team.rank} className={`pt-row ${team.top ? 'pt-row-top' : 'pt-row-lower'}`}>
                    ...
                    <td className="pt-club-cell">
                      <div className="pt-team-logo-placeholder" />
                ...
                {side3Muted && (
                  <div className="side-video-overlay" onClick={handleUnmuteSide3}>
                    <div className="side-unmute-button-container">
                      ...
                      <h4 className="side-unmute-title">TAP TO UNMUTE</h4>
                      <p className="side-unmute-subtitle">Official logo reveal</p>
                    </div>
                  </div>
                )}
              </div>
