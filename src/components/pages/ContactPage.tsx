            ...
            <div className="contact-details-grid">
              ...
              <div className="contact-detail-card">
                ...
                <div className="contact-social-icons">
                  ...
                  <a href="https://www.youtube.com/@TheAPLT20" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                  ...
                  <a href="https://www.tiktok.com/@afghanistan.premie?_r=1&_t=ZS-99BJ9dyrRqB" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
